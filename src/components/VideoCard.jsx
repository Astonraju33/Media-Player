...
const dragStarted = (e,vId)=>{
  console.log(`
  Dragging started with video id : ${vId}`);
  ...
  return (
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
        <iframe width="100%" height="300px" src={`${displayData?.youtubeLink}?autoplay=1`} title="caption" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
        </Modal.Body>
      </Modal>
    </>
  )
